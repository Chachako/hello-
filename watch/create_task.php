...
function create_task($db){
    ...
    foreach($station as $key=>$value){
        ...
        $pj_issue_sql="SELECT no from team_watch.issue_list where `project_id`='$project_id' order by id desc ";
        ...
        $sql="insert into team_watch.issue_list (no,create_user_id,product_id,project_id,build_id,
