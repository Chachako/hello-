...
function search_my_filter($db,$stageId,$stationId,$userId){
    session_start();
    $project_id=$_SESSION['cooper_user_info'][0]['project_id'];
    $where = " where 1 and f.user_id='$userId' and product_id='14' ";
    $where1="  where 1 ";
...
function search_all_filter($db,$stageId,$stationId,$userId){
    ...
    session_start();
    $project_id=$_SESSION['cooper_user_info'][0]['project_id'];
    $where = " where 1 and( f.user_id='1' or f.user_id='$userId') and product_id='14' ";
    $where1="  where 1 ";
    if($project_id!=''&&$project_id!=NULL){
        $project_id=explode('|', $project_id) ;
        for ($i = 0; $i < count($project_id); $i++) {
...
//         $a=stristr($stageId,"|");
//         if($a!=false){
//             $where .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and build_id like '%$stageId%'";

//         }else{
//             $where .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and FIND_IN_SET('$stageId',replace(f.build_id, '|',','))";
//         }
//         $countWhere = $where;
//         $account_select_sql = "SELECT f.* FROM `filter` as f $where ";
//         $account_select_result = $db->query($account_select_sql);
...
//             if($b!=false){
//                 if($a!=false){
//                     $where1 .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and station_id like '%$stationId%' and build_id like '%$stageId%'";
//                 }else{
//                     $where1 .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and FIND_IN_SET('$stageId',replace(f.build_id, '|',',')) and station_id like '%$stationId%'";
//                 } 
//             }else{
//                 if($a!=false){
//                     $where1 .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and FIND_IN_SET('$stationId',replace(f.station_id, '|',',')) and build_id like '%$stageId%'";
//                 }else{
//                     $where1 .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and FIND_IN_SET('$stationId',replace(f.station_id, '|',',')) and FIND_IN_SET('$stageId',replace(f.build_id, '|',','))";
//                 }
               
//             }
//         //    $where1 .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and build_id like '%$stageId%'  and station_id like '%$stationId%' ";
...
//         $a=stristr($stationId,"|");
//         if($a!=false){
//             $where .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and station_id like '%$stationId%'";
//         }else{
//             $where .="and( f.user_id='1' or f.user_id='$userId') and product_id='14' and FIND_IN_SET('$stationId',replace(f.station_id, '|',','))";
//         }
//         $countWhere = $where;
