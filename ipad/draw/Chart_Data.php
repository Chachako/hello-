<?
	...
	$issue_sql = "select * from team_ipad.issue_list where 1 and project_id='".$search_project."' "; /* and( status_id='1' or status_id='2' or status_id='4') */
	if($search_stage != 0){
