        ...
        if ($('#soul-filter-list' + tableId).length === 0) {
          ...
          var soulFilterList = [],
            filterItemsHtml = {
              ...
              data: '<li class="soul-dropList"><i class="soul-icon soul-icon-drop-list"></i> filter data <i class="layui-icon layui-icon-right" style="float: right"></i></li>',
              ...
              excel: '<li class="soul-export"><i class="soul-icon soul-icon-download"></i> export excel </li>',
          ...
          soulFilterList.push('<li class="soul-sort" data-value="asc" ><i class="soul-icon soul-icon-asc"></i> asc oder </li>');
          soulFilterList.push('<li class="soul-sort" data-value="desc"  style="border-bottom: 1px solid #e6e6e6"><i class="soul-icon soul-icon-desc"></i> desc oder  </li>');
          ...
          soulFilterList.push('</ul><div id="soul-dropList' + tableId + '" style="display: none"><div class="filter-search"><input type="text" placeholder="please search" class="layui-input"></div><div class="check"><div class="multiOption" data-type="all"><i class="soul-icon">&#xe623;</i> select all</div><div class="multiOption" data-type="none"><i class="soul-icon">&#xe63e;</i> clear</div><div class="multiOption" data-type="reverse"><i class="soul-icon">&#xe614;</i>invert select</div></div><ul></ul></div>');
          ...
          $('#main-list' + tableId + ' .soul-export').on('mouseover', function (e) {
            ...
            _this.export(table_cache[myTable.id],{
              columns:['no','product','project','build','station','task_title','new_status','priority','toUser','requestor','version','eta']
            })
          });
        ...
        if ($tableHead.find('.soul-table-filter').length > 0) {
          ...
          if (columnField.length > 0) {
            if (typeof myTable.url !== 'undefined' && myTable.page) {
              ...
              // $.ajax({
              //   url: "test.php?action=task_all_list",
              //   data: {
              //     datas,
              //     choose:"setting"
              //   },
