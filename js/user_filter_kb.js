...
layui.config({
    ...
    //表格渲染
    $.ajax({
        url: '../../kb/filter/filter_handle.php?action=account_list',
        dataType: 'json',
        success: function (res) {
    ...
    var mytable=table.render({
        elem: '#userTable',
        // url: '../../kb/filter/filter_handle.php?action=account_list', //数据接口,
        id: 'userTable',
        height: 'full-200',
        align: 'right',
        loading: true,
    ...
    $(".myfilter").click(function(){
        ...
        stationId = array1.join("|");
        $.ajax({
            url: '../../kb/filter/filter_handle.php?action=my_account_list',
            dataType: 'json',
            data:{
                stageId:stageId,
                stationId:stationId
    ...
    table.on('row(user)', function (obj) {
        ...
        var url = '../../kb/filter/edit_filter.html?filter_id=' + filter_id + '&scrollTop=' + scrollTop;
